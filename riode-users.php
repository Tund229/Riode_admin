                ...
                <ul class="nav navbar-nav">
                  ...
                  <div class="card card-table-border-none" id="recent-orders">
                    <div class="card-header justify-content-between">
                      <h2 >LISTES DES ADMINISTRATEURS RIODE ECOM</h2> 
                    </div>
                    <div class="card-body pt-0 pb-5">
                      <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                          ...
                          <?php
                          $sql="SELECT register_id, register_name, register_email FROM users";
                          ...
                          <tbody>
                            <tr>
                              <td> <?php echo $val["register_id"]; ?> </td>
                              <td> <?php echo $val["register_name"];?> </td>
                              <td> <?php echo $val["register_email"];?> </td>
                              <?php 
                                if(session_start() AND $_SESSION["admin_name"]=="Tunde"){
                              ?>
                              <td>
